package com.demo.core.server.netty;
 ...
 * Created by dragon
 *
 * 服务端的netty接收到请求后，找到并调用实现类的方法
 */
public class RpcServerRequestHandler extends SimpleChannelInboundHandler<Request>{
    ...
    //此处应该传入服务的实现方
    public RpcServerRequestHandler(Object service){
